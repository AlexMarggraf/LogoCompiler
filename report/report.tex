...
%% for colors
\usepackage{xcolor} % must be loaded early
...
\date{June 11, 2025 \vfill \includegraphics{resources/UniBas_Logo_EN_Schwarz_RGB_65.pdf}}
...
\begin{document}
    ...
    \input{sections/polymorphic_inline_caches.tex}
    \input{sections/implementation.tex}
    \input{sections/performance_of_different_approaches.tex}
    \input{sections/comparison_with_xlogoonline.tex}
    \input{sections/conclusion.tex}
    \input{sections/individual_contributions.tex}
