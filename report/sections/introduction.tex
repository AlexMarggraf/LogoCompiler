...
implementation requires the code to be present in a text file, as
used by XLogoOnline, or it can be written directly in the
application. This allows the program to easily parse the contents
...
the average compile time and runtime, and computed the standard
