...
\begin{tabular}{|p{4.7cm}|p{10.4cm}|}
    ...
    \hline
    \texttt{to $n$ $p$ \newline \phantom{mm}$s$ \newline end}& declare a procedure with name $n$ which executes the statements $s$. $p$ is the list of parameters accepted by that procedure which can be used by the statements $s$ \\
    \hline
\end{tabular}
